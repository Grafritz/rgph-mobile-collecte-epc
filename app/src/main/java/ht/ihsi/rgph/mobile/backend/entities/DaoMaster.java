...
import ht.ihsi.rgph.mobile.backend.entities.DataBaseUpgrade;
...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        EmigreDao.createTable(db, ifNotExists);
        DecesDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        EmigreDao.dropTable(db, ifExists);
        DecesDao.dropTable(db, ifExists);
    ...
    public static class DatabaseContext extends ContextWrapper {
        ...
        private static final String DATABASE_DIR="rgph_db";
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(EmigreDao.class);
        registerDaoClass(DecesDao.class);
