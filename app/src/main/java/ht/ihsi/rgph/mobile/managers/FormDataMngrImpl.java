...
import ht.ihsi.rgph.mobile.backend.entities.CategorieQuestionDao;
import ht.ihsi.rgph.mobile.backend.entities.CommuneDao;
import ht.ihsi.rgph.mobile.backend.entities.DepartementDao;
import ht.ihsi.rgph.mobile.backend.entities.ModuleDao;
import ht.ihsi.rgph.mobile.backend.entities.PaysDao;
import ht.ihsi.rgph.mobile.backend.entities.PersonnelDao;
import ht.ihsi.rgph.mobile.backend.entities.QuestionDao;
import ht.ihsi.rgph.mobile.backend.entities.QuestionModuleDao;
import ht.ihsi.rgph.mobile.backend.entities.QuestionReponseDao;
import ht.ihsi.rgph.mobile.backend.entities.VqseDao;
import ht.ihsi.rgph.mobile.backend.entities.CategorieQuestion;
import ht.ihsi.rgph.mobile.backend.entities.Commune;
import ht.ihsi.rgph.mobile.backend.entities.Departement;
import ht.ihsi.rgph.mobile.backend.entities.DomaineEtude;
import ht.ihsi.rgph.mobile.backend.entities.Module;
import ht.ihsi.rgph.mobile.backend.entities.Pays;
import ht.ihsi.rgph.mobile.backend.entities.Personnel;
import ht.ihsi.rgph.mobile.backend.entities.Question;
import ht.ihsi.rgph.mobile.backend.entities.QuestionModule;
import ht.ihsi.rgph.mobile.backend.entities.QuestionReponse;
